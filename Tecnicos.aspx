<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="Tecnicos.aspx.cs" Inherits="TallerDeReparaciones.Tecnicos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container text-center">
        ...
        Nombre del Tecnico:
    <asp:TextBox ID="TextBoxtechname" class="form-control" runat="server"></asp:TextBox>
        Especialidad:
    <asp:TextBox ID="TextBoxespecialidad" class="form-control" runat="server"></asp:TextBox>
    </div>
